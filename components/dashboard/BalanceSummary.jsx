  ...
  return (
    <div className="bg-[#fffeff] rounded-3xl p-8 transition-all duration-300 border-2 border-gray-200 shadow-sm m-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Net Change */}
        <div className={`group p-6 rounded-2xl border-2 transition-all duration-300 shadow-sm hover:shadow-md
          ${netChange >= 0 
        ...
        >
          ...
          <h2 className={`text-2xl font-semibold tracking-tight transition-colors
            ...
            {netChange >= 0 ? '+' : '-'}R{Math.abs(netChange).toLocaleString('en-US', { minimumFractionDigits: 2 })}
          </h2>
        </div>
      </div>
    </div>
